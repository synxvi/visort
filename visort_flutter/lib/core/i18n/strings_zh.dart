...
const Map<String, String> stringsZh = {
  ...
  'search_states': '省份',
  'search_metadata': '元数据',
  'search_missing_date': '缺少日期',
  'search_unlocated': '未定位',
  ...
  'search_places_hint_index': '在设置中开启「智能识别索引」，扫描后按拍摄城市分组。',
  ...
  'settings_ml_data': '索引数据',
  'settings_ml_data_value': '已索引 {n} 张',
  'settings_ml_off_title': '关闭智能识别索引？',
