...
const Map<String, String> stringsZh = {
  ...
  'search_people': '人物',
  'search_people_empty': '未检测到人物',
  'search_people_hint': '人物分组需要人脸识别模型（当前版本未内置），后续版本开放。',
  'search_places': '位置',
  'search_places_empty': '暂无位置信息',
  'search_places_hint': '在设置中开启「机器学习索引」，扫描后自动按拍摄地点分组。',
  'search_types': '文件类型',
  'search_clear': '清除',
  'view_immersive': '沉浸视图',
  'view_date': '日期视图',
  ...
  'settings_section_ml': '机器学习',
  'settings_ml_index': '机器学习索引',
  'settings_ml_index_note': '扫描全部照片提取拍摄位置等信息，供搜索页分类展示。',
  'settings_ml_face': '人物识别',
  'settings_ml_face_note': '按人物自动分组。需要人脸检测模型，当前版本未内置。',
  'settings_ml_place': '位置识别',
  'settings_ml_place_note': '按拍摄地点自动分组照片。',
  'settings_ml_progress': '索引进度',
  'settings_ml_indexed_of': '已索引 {0} / {1} 张',
  'settings_ml_running': '正在索引…',
  'settings_ml_done': '已完成',
  'settings_ml_off_title': '关闭机器学习索引？',
  'settings_ml_off_desc': '关闭后将清除已索引的位置数据。',
  'layout_list': '列表',
  'layout_grid': '网格',
  'grid_columns': '网格列数',
  // 日期分组/详情面板
